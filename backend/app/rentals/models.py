...
class RentalItem(Base):
    ...
    product_id = Column(UUID(as_uuid=True), ForeignKey("products.id", ondelete="RESTRICT"), index=True, nullable=False)
    variant_id = Column(UUID(as_uuid=True), ForeignKey("product_variants.id", ondelete="RESTRICT"), index=True, nullable=True)
    asset_id = Column(UUID(as_uuid=True), ForeignKey("product_assets.id", ondelete="SET NULL"), index=True, nullable=True)
